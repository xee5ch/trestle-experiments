...
- \[a_obj\] security functional requirements;

- \[b_obj\] security strength requirements;

- \[c_obj\] security assurance requirements;

- \[d_obj\] security-related documentation requirements;

- \[e_obj\] requirements for protecting security-related documentation;

- \[f_obj\] description of:

  - \[1\] the information system development environment;
  - \[2\] the environment in which the system is intended to operate; and

- \[g_obj\] acceptance criteria.
